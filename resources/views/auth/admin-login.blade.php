...
<head>
    ...
    <title>Admin Login - T-Conn POS</title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="flex justify-center mb-8">
            <div class="flex items-center gap-2">
                ...
                <span class="text-3xl font-bold tracking-tight text-slate-900">T-Conn <span class="text-indigo-600 font-medium">Admin</span></span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden relative">
            ...
            <div class="p-8">
                <h2 class="text-xl font-semibold text-slate-800 mb-2">Admin sign in</h2>
                <p class="text-slate-500 text-sm mb-6">Enter your admin credentials to access the administration dashboard.</p>
            ...
            <div class="px-8 py-4 bg-slate-50 border-t border-slate-100 text-center">
                <p class="text-xs text-slate-500">Administration portal for T-Conn POS system.</p>
            </div>
        </div>
    </div>
